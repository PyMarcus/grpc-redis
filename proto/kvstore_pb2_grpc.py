...
import proto.kvstore_pb2 as kvstore__pb2
...
class KVStoreStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Del = channel.unary_unary(
                '/proto.KVStore/Del',
                request_serializer=kvstore__pb2.DelRequest.SerializeToString,
                response_deserializer=kvstore__pb2.DelResponse.FromString,
                _registered_method=True)
        self.StreamSet = channel.stream_stream(
                '/proto.KVStore/StreamSet',
                request_serializer=kvstore__pb2.SetRequest.SerializeToString,
                response_deserializer=kvstore__pb2.SetResponse.FromString,
                _registered_method=True)
        self.StreamGet = channel.stream_stream(
                '/proto.KVStore/StreamGet',
                request_serializer=kvstore__pb2.GetRequest.SerializeToString,
                response_deserializer=kvstore__pb2.GetResponse.FromString,
                _registered_method=True)
...
def add_KVStoreServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Del': grpc.unary_unary_rpc_method_handler(
                    servicer.Del,
                    request_deserializer=kvstore__pb2.DelRequest.FromString,
                    response_serializer=kvstore__pb2.DelResponse.SerializeToString,
            ),
            'StreamSet': grpc.stream_stream_rpc_method_handler(
                    servicer.StreamSet,
                    request_deserializer=kvstore__pb2.SetRequest.FromString,
                    response_serializer=kvstore__pb2.SetResponse.SerializeToString,
            ),
...
class KVStore(object):
    ...
    def Del(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/proto.KVStore/Del',
            kvstore__pb2.DelRequest.SerializeToString,
            kvstore__pb2.DelResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
